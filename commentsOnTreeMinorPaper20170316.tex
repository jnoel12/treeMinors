...
%----------------------------------------------------------------------
\tikzset{
  bigblack/.style={circle, draw=black!100,fill=black!100,thick, inner sep=1.5pt, minimum size=6mm},
  blackcirc/.style={circle, draw=black!100,thick, inner sep=1.5pt, minimum size=6mm},  
}
...
\newtheorem{almost}[equation]{Almost Theorem}
\newtheorem{thm}[equation]{Theorem}
\newtheorem{lem}[equation]{Lemma}
\newtheorem{prop}[equation]{Proposition}
\newtheorem{conj}{Conjecture}
\newtheorem{possThm}[equation]{Possible Theorem}
\newtheorem{cor}[equation]{Corollary}
\newtheorem{claim}[equation]{Claim}
\newtheorem{ques}[conj]{Question}
\newtheorem{prob}[conj]{Problem}
\newtheorem{selves}[equation]{Note To Selves}
\newtheorem{fact}[equation]{Fact}
\newtheorem{possible}[equation]{(Possible) Theorem}
\newtheorem*{extremal}{Main Extremal Problem}
\newtheorem*{maxTime}{Maximum Running Time Problem}
\newtheorem*{critDensity}{Critical Density Problem}
\newtheorem*{maxMin}{Largest Minimal Percolating Set Problem}
